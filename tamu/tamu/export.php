...
?>
  ...
  <body>
    ...
    <br>
    <h2 style="text-align: center;"><u>Laporan Data Tamu</u></h2>
    <br>
    ...
    <table class="table bordered">
      <colgroup>
        ...
        <col style="width: 27%" class="angka">
        <col style="width: 7%" class="angka">
        <col style="width: 10%" class="angka">
        <col style="width: 23%" class="angka">
        <col style="width: 10%" class="angka">
      </colgroup>
      <thead>
            <tr>
          ...
          <tbody>
            ...
            $no = 1;
            $query = "SELECT *, tb_pegawai.nama AS nama_pegawai FROM tb_tamu
