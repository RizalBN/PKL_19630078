           ...
           <div class="row">
             <div class="col-6">
               <div class="form-group">
                 ...
                 <input type="text" class="form-control" id="nip" name="nip" required placeholder="Masukkan Nomor Induk Pegawai" value="<?= $row['nik'] ?>">
               </div>
             </div>
             <div class="col-6">
               <div class="form-group">
                 <label>Nama Pegawai</label>
                 <input type="text" class="form-control" name="nama_pegawai" required placeholder="Masukkan Nama Pegawai" value="<?= $row['nama_pegawai'] ?>">
               </div>
             </div>
